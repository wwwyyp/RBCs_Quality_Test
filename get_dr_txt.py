...
class mAP_YOLO(YOLO):
    ...
    def detect_image(self, image_id, image):
        ...
        print(out_boxes[0][1])
        print(str(out_scores.numpy()))
        print(str(out_classes.numpy()))
...
image_ids = open('VOCdevkit/VOC2007/ImageSets/Main/OnlyTest.txt').read().strip().split()
...
for image_id in tqdm(image_ids):
    ...
    image_path = "./VOCdevkit/VOC2007/JPEGImages_OnlyTest/" + image_id + ".png"
