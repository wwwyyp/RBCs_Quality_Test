...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    video_path      = 'D:/Python_PyCharm_projects/yolov4-tf2-master-cells/img/bloodcell_blueball_5um.mp4'
    # video_path      = 0
    video_save_path = "D:/Python_PyCharm_projects/yolov4-tf2-master-cells/video_output_savepath"
    video_fps       = 25.0
    ...
    if mode == "predict":
        ...
        '''
        while True:
            img = input('Input image filename:')   # 返回的 img = 'D:\Python_PyCharm_projects\yolov4-tf2-master\img\street.jpg'
            try:
